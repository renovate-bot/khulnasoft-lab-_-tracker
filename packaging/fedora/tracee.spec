...
URL:		https://github.com/khulnasoft-labs/tracee
Source:		/tracee/tracee

%description
Tracker eBPF is a security and forensics tool. It uses Linux eBPF technology to
...
complete security runtime detection system. Tracker rules is a security
detection engine and receives events from Tracker eBPF and, according to defined
...
%description rules
Tracker rules is a security detection engine and receives events from Tracker
